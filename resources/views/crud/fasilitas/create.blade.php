    ...
    <div class="container">
        ...
        <form action="{{ route('fasilitas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="deskripsi_fasilitas" name="deskripsi_fasilitas" class="form-control" required></textarea>
            </div>
            <div class="form-group">
                <label for="foto_fasilitas">Foto Fasilitas</label>
                <input id="foto_fasilitas" name="foto_fasilitas" class="form-control-file"
                    placeholder="masukan url image" required>
            </div>
